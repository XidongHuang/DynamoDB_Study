...
public class BatchWrite {
	...
	public static void main(String[] args) {
		...
		threadTableKeysANdAttributes.addHashAndRangePrimaryKeys("ForumName", "Subject", "Amazon DynamoDB",
				"DynamoDB Thread 1", "Amazon DynamoDB", "DynamoDB Thread2", "Amazon S3", "S3 Thread 1");
		BatchGetItemOutcome outcome2 = dynamoDB.batchGetItem(forumTableKeysAndAttributes, threadTableKeysANdAttributes);
	...
	private static void batchWrite() {
		...
		TableWriteItems threadTableWriteItems = new TableWriteItems("Thread")
				...
				.withHashAndRangeKeysToDelete("ForumName", "Some hash attribute value", "Amazon S3",
						"Some range attribute value");
